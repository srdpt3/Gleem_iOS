...
let TEXT_SIGNIN_SUBHEADLINE = "나의 첫인상을 실시간으로 평가받고 원하는 이성과 매칭"
...
public let PHOTOUPLOAD_FROM_MAIN = "투표 사진 올리기"

public let SELECT_ATTRIBUTES = "사진에 대한 5가지 평가 키워드를 선택해주세요"
